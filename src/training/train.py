...
# Constantes
# valores por defecto; pueden sobreescribirse mediante argumentos CLI
...
def main(entrada: str, validacion: str, salida: str):
    ...
    guardar_modelo(modelo_random_forest, salida)
    logger.info("Modelo guardado en: %s", salida)
...
if __name__ == "__main__":
    ...
    main(args.entrada, args.validacion, args.salida)
